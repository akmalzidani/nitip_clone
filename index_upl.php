      ...
      <div class="col py-3" style="margin-left:17%">
        <div class="container ">
          <div class=" container pt-5">
            <div style="height:9vh"></div>
            <h2 class="text-center">TUGAS MAHASISWA</h2>
          </div>
          <br>
          <br>
          <div class="row mx-2">

            <?php if ($_SESSION['nama'] == 'Fitri Setyorini' || $_SESSION['roles'] == 'Mahasiswa') : ?>
            <div class="col-md-12">
              <div class="my-4 box-shadow">
                <div class="card shadow p-3 py-2">
                  <a href="matkul.php?tempe=Sistem Operasi">
            ...
            <?php endif; ?>
            <?php if ($_SESSION['nama'] == 'Entin Martiana' || $_SESSION['roles'] == 'Mahasiswa') : ?>
            <div class="col-md-12">
              <div class="my-4 box-shadow">
                <div class="card shadow p-3 py-2">
                  <a href="matkul.php">
            ...
            <?php endif; ?>
            <?php if ($_SESSION['nama'] == 'Ervan Kus Indarto' || $_SESSION['roles'] == 'Mahasiswa') : ?>
            <div class="col-md-12">
              <div class="my-4 box-shadow">
                <div class="card shadow p-3 py-2">
                  <a href="matkul.php">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-12">
                        <label for="matkul">Masukkan nama matkul </label><br>
                        <input type="text" name="matkul" class="form-control mb-2" required>
                      </div>
                    </div>
                </div>
